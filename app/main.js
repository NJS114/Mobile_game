...
const dom = {
  ...
  manaChat: document.getElementById("mana-chat"),
  manaChien: document.getElementById("mana-chien"),
  deckChat: document.getElementById("deck-chat"),
  deckChien: document.getElementById("deck-chien"),
